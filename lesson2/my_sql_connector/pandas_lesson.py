...
#
# df = pd.read_csv('2019.csv', header=None)

# df = pd.read_csv('2019.csv', header=None, names=['Name', 'Date of birth', 'Hometown'])

# df = pd.read_csv('2019.csv', nrows=5)

# df.to_csv('2019_copy.csv', index=False, header=False)
# #
...
# df.insert(loc=2, column='New column', value=df['GDP per capita'] ** 2)
...
print(df1)
print(df2)
df3 = pd.read_csv('test.csv', header=None, names=['Name', 'DOB', 'Town'])
